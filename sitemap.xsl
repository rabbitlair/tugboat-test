  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <script type="text/javascript" src="/parser-date-iso8601.min.js"/>
        <script type="text/javascript" src="/simple_sitemap.xsl.js"/>
        <link href="/simple_sitemap.xsl.css" type="text/css" rel="stylesheet"/>
      </head>
      <body>
        <header role="banner">
          <h1>Sitemap file</h1>
